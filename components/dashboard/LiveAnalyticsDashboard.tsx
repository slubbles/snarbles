...
const LiveAnalyticsDashboard: React.FC = () => {
  ...
  const fetchAnalytics = useCallback(async () => {
    try {
      ...
      const colors = ['#8884d8', '#82ca9d', '#ffc658', '#ff7300', '#00ff88', '#ff0066'];
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500">Connecting to live data...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Real-time insights for Snarbles platform</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Token Success Rate</CardTitle>
            <Target className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">{metrics.tokenCreationRate}%</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">${metrics.revenueToday}</div>
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Hourly user activity and events</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Live user activity as it happens</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {realtimeEvents.map((event, index) => (
                  <div key={event.id} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="font-medium">{event.event_name?.replace('_', ' ') || 'Activity'}</span>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold">{metrics.avgSessionTime} min</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold">{metrics.retentionRate}%</span>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Real-time revenue metrics</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={timeSeriesData}>
                    ...
                    <Line type="monotone" dataKey="revenue" stroke="#00C851" strokeWidth={3} />
                  </LineChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Token Creation Revenue</CardTitle>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={timeSeriesData}>
                    ...
                    <YAxis />
                    <Tooltip />
                    <Bar dataKey="tokens" fill="#FF6384" />
                  </BarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
                  ...
                  return (
                    <div key={step.step} className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm text-gray-500">{step.count} users</span>
                      </div>
