...
import { PeraMobileConnector } from './PeraMobileConnector';
...
export const AlgorandWalletModal: React.FC<AlgorandWalletModalProps> = ({
  isOpen,
  onClose
}) => {
        ...
        <div className="p-6">
          <div className="mb-6">
            <p className="text-[rgb(254,254,235)] text-sm leading-relaxed mb-4">
              Since you're using the Pera wallet app, you can connect directly to access Algorand features.
            </p>
            
            <div className="bg-[rgb(254,254,235)] bg-opacity-10 rounded-lg p-4 mb-4">
              <h3 className="text-[rgb(254,254,235)] font-semibold mb-2">
                What you can do with Algorand:
              </h3>
              <ul className="text-[rgb(254,254,235)] text-sm space-y-1">
                <li>• Purchase algo credits with ALGO</li>
                <li>• Access Algorand-based features</li>
                <li>• Manage ALGO transactions</li>
                <li>• Use Algorand smart contracts</li>
              </ul>
            </div>
          </div>

          {/* Pera Connector */}
          <PeraMobileConnector onConnectionChange={(connected) => {
            if (connected) {
              onClose();
            }
          }} />
          ...
          <div className="mt-6 pt-6 border-t border-[rgb(254,254,235)] border-opacity-30">
            ...
            <div className="space-y-2 text-sm text-[rgb(254,254,235)]">
              <p>• Make sure you have the latest Pera Wallet app version</p>
